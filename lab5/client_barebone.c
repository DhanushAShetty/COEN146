// Name: Manpreet Sokhi
// Date: April 29, 2020
// Title: Lab assignment 5: Stop and Wait for an Unreliable Channel
// Description: This program is the client for a Stop and Wait reliable protocol built on top of UDP to provide a reliable transport service
...
void ClientSend(int sockfd, const struct sockaddr *address, socklen_t addrlen, Packet packet) {
    while (1) {
        ...
        } else if (recvpacket.header.seq_ack != seq) { // sequence number
